	...
	<div class="container my-3 border border-primary"
		...
		<div
			...
			<h3 class="text text-center text-dark fw-semibold">
				العطل الخاصة ب <a href="/employees/${employee.id}"
		...
		<table
			...
			<thead>
				<tr>
					<th colspan="2"><a href="/leaves/sick/${employee.id}"
					...
					<th colspan="2"
						...
						href="/leaves/specific/${employee.id}"
						class="link-underline-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover text text-primary">العطل
							الإستثنائية</a></th>
					<th colspan="2"><a href="/leaves/annual/${employee.id}"
						class="link-underline-primary link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover text text-primary">العطل
							السنوية</a></th>
					...
					<c:otherwise>
						...
						<c:forEach var="leave" items="${leaves}">
							...
							<tr class="border-bottom border-dark-subtle leave-row"
								data-start-date="${leave.startDate}"
								data-end-date="${leave.endDate}">
