...
<title>Employee Sick Leaves</title>
<script>
...
function calculateSick() {
    var startDate = document.getElementById("startDate").valuD
		...
		<div
			...
			<div
				...
				<h3 class="text text-center text-dark fw-semibold">
					العطل المرضية الخاصة ب <a href="/employees/${employee.id }"
			...
			<tbody class="table-group-divider">
				...
				<c:choose>
					<c:when test="${empty leaves}">
						<tr>
							<td colspan="8">لا توجد معلومات عن الإجازة المرضية متاحة
								لهذا الموظف</td>
						</tr>
					</c:when>
					<c:otherwise>
