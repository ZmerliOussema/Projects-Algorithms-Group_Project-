...
//*****View all leaves for admin******		
	...
	public String adminDashboard(HttpSession session, Model model, Leave leave) {
		...
		if (session.getAttribute("userId") == null || session.getAttribute("isAdmin") == null
				|| !(Boolean) session.getAttribute("isAdmin")) {
			return "redirect:/logout";
		}

		model.addAttribute("leaves", leaveService.all());
    	model.addAttribute("employee", employeeService.findById((Long)session.getAttribute("userId")));
...
//*****View and add annual leaves for employee******
	...
	public String addAnnualLeave(@Valid @ModelAttribute("leave") Leave leave, BindingResult result,
			HttpSession session) {
...
//*****View and add specific leaves for employee******
	...
	public String addSpecificLeave(@Valid @ModelAttribute("leave") Leave leave, BindingResult result,
			HttpSession session) {
