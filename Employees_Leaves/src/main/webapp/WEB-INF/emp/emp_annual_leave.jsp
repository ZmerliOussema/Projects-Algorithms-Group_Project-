...
<head>
    ...
    <script>
        ...
        function calculateAnnual() {
            ...
            document.getElementById("annual").value = differenceInDays;
        }
    </script>
</head>
    ...
    <table
        ...
        <c:choose>
            <c:when test="${empty leaves}">
                <tr>
                    <td colspan="4" class="text-center">لا يوجد عطل سنوية</td>
                </tr>
            </c:when>
            <c:otherwise>
        ...
        <c:if test="${user.role == 'admin'}">
            <form:form action="/employees/annual/add" method="post" modelAttribute="newLeave">
                <tr>
                        <td>
                        ...
                        <td><form:input path="annual" type="number" class="form-control text-center" name="annual"
                                        id="annual" value="0" style="background-color: #ebca6eaf;"/></td>
                        <td><form:input path="end_date" type="date" class="form-control"
                                        name="end_date" id="end_date" onchange="calculateAnnual()"
                                        style="background-color: #ebca6eaf;"/></td>
                        <td><form:input path="start_date" type="date" class="form-control"
                                        name="start_date" id="start_date" onchange="calculateAnnual()"
                                        style="background-color: #ebca6eaf;"/></td>
