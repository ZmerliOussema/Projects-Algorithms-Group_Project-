		...
		<div
			...
			<div
				...
				<h3 class="text text-center text-dark fw-semibold">
					العطل السنوية الخاصة ب <a href="/employees/show/1"
		...
		<table
			...
			<tbody class="table-group-divider">
				...
				<c:if test="${user.role == 'admin'}">
					<form:form action="/employees/annual/add" method="post"
						...
						<tr>
							...
							<td><form:input path="start_date" type="date"
									class="form-control text-center" name="start_date"
									id="start_date" onchange="calculateAnnual()"
									style="background-color: #ebca6eaf;" /></td>
