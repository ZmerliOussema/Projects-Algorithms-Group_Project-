...
<body style="background-color: #161615;">
	<form:form action="/login" method="post" modelAttribute="newEmployee">
		<div
			...
			<div class="d-flex justify-content-between">
				<div>
					...
					<div class="mb-3" style="width: 470px;">
						<label class="form-label fw-bold">E-mail (البريد
							الالكتروني):</label>
						<form:input path="" type="email" class="form-control" />
					</div>
					<div class="mb-3" style="width: 470px;">
					...
					<div class="mb-3" style="width: 470px;">
						...
						<form:textarea path="" class="form-control" rows="2" />
					</div>
				...
				<div>
					<div class="mb-3" style="width: 470px;">
						...
						<form:input path="" type="text" class="form-control text-end" />
					</div>
					<div class="mb-3" style="width: 470px;">
					...
					<div class="mb-3" style="width: 470px;">
						...
						<form:textarea path="" class="form-control text-end" rows="2" />
					</div>
					<div class="mb-3" style="width: 470px;">
						<label class="form-label d-flex justify-content-end fw-bold">:الخطة</label>
						<form:select path="" class="form-select text-end">
